...
### Note
These initial values were not high enough in some box-layers and the initial iron levels did not support iron flux on day 1 which led to the model crashing immediately. The following box-layers were overwritten by the values which Mao had in the input file when Denise took over:
Box 2-13 Layer 1: Increased from 0.0055845 to 0.0279225.
Box 2-13 Layer 2: Increased from 0.011169 to 0.05863725.
