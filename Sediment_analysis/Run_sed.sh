...
## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ##
atlantisMerged -i final_no_ice_input.nc 0 -o output.nc -r SO28_run.prm -f SO28_forcedummy.prm -p SO28_physics.prm -b SO28_biol_mod.prm -h SO28_harvest_nofishing.prm -s AntarcticGroupsnew.csv -d output_test_sed
